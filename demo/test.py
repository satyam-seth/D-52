...
# Progress Report
progress_report=driver.find_element_by_xpath('//*[@id="navbarSupportedContent"]/ul/li[3]/a')
...
login.click()
time.sleep(2)
login_btn=driver.find_element_by_xpath('/html/body/div[2]/div/div/div[2]/form/div[3]/input')
login_btn.click()
...
time.sleep(2)
search_btn=driver.find_element_by_xpath('//*[@id="navbarSupportedContent"]/form/button')
search_btn.click()
time.sleep(2)
page_down()
time.sleep(5)
...
more.click()
time.sleep(2)
download=driver.find_element_by_xpath('//*[@id="navbarSupportedContent"]/ul/li[5]/div/a[1]')
download.click()
time.sleep(2)
page_down()
time.sleep(5)
...
for i in range(1,6):
    download_btn=driver.find_element_by_xpath(f'/html/body/div[3]/div/table/tbody/tr[{i}]/td/a')
    download_btn.click()
    time.sleep(5)
...
more.click()
time.sleep(2)
download=driver.find_element_by_xpath('//*[@id="navbarSupportedContent"]/ul/li[5]/div/a[2]')
download.click()
time.sleep(2)
page_down()
time.sleep(5)
...
more.click()
time.sleep(2)
admin=driver.find_element_by_xpath('//*[@id="navbarSupportedContent"]/ul/li[5]/div/a[3]')
admin.click()
...
login.click()
time.sleep(5)
forget_btn=driver.find_element_by_xpath('/html/body/div[2]/div/div/div[2]/form/div[3]/a')
forget_btn.click()